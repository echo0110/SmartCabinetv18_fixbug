...
//	recv_data = (char *)pvPortMalloc(maxElementsOfFile);
//	
...
//		res=transport_open((s8*)host_name,(s32)port);		
//		if(res == 0)
//		{
//			SIM_CON_OK = 1;			
//			
...
//		while(1)
//	{
//		bytes_received = lwip_recv(tcpclient_sock, recv_data, maxElementsOfFile, 0);
//	  extern int lwip_get_error(int s);
//		err_t client_err = lwip_get_error(tcpclient_sock);
//		if(client_err == ERR_OK)
//		{
//			recv_data[bytes_received] = '\0';
//			if(bytes_received > 0)
//			{
//				//client_err = ParseServerRequest(tcpclient_sock, recv_data, bytes_received);
//				// ??????,3s?????????
//				//clientGetDatas = 3;
//			}
//		}
...
//		{
//			// ????/??
//			//linkState = LINK_SERVER_ERROR;
//			
//			/* ?????? */
//			lwip_close(tcpclient_sock);
//			
//			/* ?????? */
//			vPortFree(recv_data);
//			break;
