...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
//long long Mass_Memory_Size[MAX_LUN+1] = {1024*1024*12, };//前12M字节
//u32 Mass_Block_Size[MAX_LUN+1] = {512, };//设置SPI FLASH的操作扇区大小为512
//u32 Mass_Block_Count[MAX_LUN+1] = {1024*1024*12/512, };
